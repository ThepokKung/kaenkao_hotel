                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        <thead>
                                            <tr>
                                                ...
                                                <th align="center">เช็คอิน</th>
                                                <th align="center">เช็คเอาท์</th>
                                                <th align="center">ค่าเช่าห้องราคา</th>
                                                <th align="center">ค่าเช่าเตียงเพิ่ม</th>
                                                <th align="center">ค่าอาหาร </th>
                                                <th align="center">รวมทั้งหมด</th>
                                                <th align="center">กำไร(ประมาณ)</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            while ($row = mysqli_fetch_array($re)) {
                                                ...
                                                if ($id % 2 == 1) {
													...
													<td align='center'>" . $row['cout'] . "</td>
													
													
													<td align='center'>$" . $row['ttot'] . "</td>
													<td align='center'>$" . $row['mepr'] . "</td>
													<td align='center'>$" . $row['btot'] . "</td>
													<td align='center'>$" . $row['fintot'] . "</td>
													<td align='center'>$" . $row['fintot'] * 10 / 100 . "</td>
													</tr>";
                                                } else {
