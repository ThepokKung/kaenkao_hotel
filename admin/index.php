      ...
      <form method="post">
        ...
        <fieldset class="clearfix">
          ...
          <p>
            ...
            </span><input type="password" name="pass" value="Password" onBlur="if(this.value == '') this.value = 'Password'" onFocus="if(this.value == 'Password') this.value = ''" required>
